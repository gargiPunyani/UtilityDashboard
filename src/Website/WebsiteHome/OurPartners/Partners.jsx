  ...
  return (
    <div>
      <div className="partnerOuter bg-white px-5 py-10 ">
        ...
        <div className="grid grid-cols-3 md:grid-cols-6 gap-3 items-center justify-center max-w-screen-xl mx-auto">
          {ourPartners.map((item) => {
            return (
              <div key={item.id}>
                <div className="shadow-xl rounded-lg bg-white-200 ">
                  <img src={item.image} alt="our-partners" className="w-full" />
                </div>
              </div>
            );
          })}
