  ...
  return (
    ...
    >
      <div className={`sideNavOuter h-screen relative `}>
        <div
          className="sideNavInner cursor-pointer  p-1 flex flex-row gap-5 items-center text-xs "
          style={{ marginTop: `${isopen ? "10px" : "0px"}` }}
        >
          <div
            className="logo h-20 w-48  transition-all ease-in-out duration-300"
            style={{
          ...
          <div
            className={`logoAlphabet  display ${
              isopen ? "block" : "hidden"
            } w-20 p-2 ease-in-out sm:display ${
              isopen ? "block" : "hidden"
            } duration-300 overflow-hidden transform ${
              isopen ? "translateX(100%) block" : "translateX(0) none"
            }`}
          >
        ...
        <div className="sideNavBar">
          ...
          >
            ...
            >
              <FontAwesomeIcon
                icon={faAngleDown}
                className="block"
                style={{ display: `${dropdown.one ? "none " : "block"}` }}
              />
              <FontAwesomeIcon
                icon={faAngleUp}
                className="hidden"
                style={{
                  display: `${dropdown.one ? "block " : "none"}`,
                  color: `${dropdown.one ? "#0056DC " : ""}`,
                }}
              />
            </div>
          ...
          >
            ...
            <ul>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400  ">
                <Link to="/dashboard">
                  <FontAwesomeIcon icon={faAnglesRight} /> Admin Dashboard
                </Link>
              </li>
            </ul>
            {/* </div>} */}
          ...
          >
            ...
            >
              <FontAwesomeIcon
                icon={faAngleDown}
                className="block"
                style={{ display: `${dropdown.two ? "none " : "block"}` }}
              />
              <FontAwesomeIcon
                icon={faAngleUp}
                className="hidden"
                style={{
                  display: `${dropdown.two ? "block " : "none"}`,
                  color: `${dropdown.two ? "#0056DC " : ""}`,
                }}
              />
            </div>
            ...
            <ul>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400 ">
                <Link to="/field-executive">
                  <FontAwesomeIcon icon={faAnglesRight} /> FieldExecutive(FE)
                  (1)
                </Link>
              </li>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400 uppercase ">
                <Link to="/franchise">
                  ...
                  <FontAwesomeIcon icon={faAnglesRight} /> FRANCHISE(FSDS)
                </Link>
              </li>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400 uppercase ">
              ...
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400 uppercase ">
                <Link to="/distributor-ds">

                  <FontAwesomeIcon icon={faAnglesRight} /> Distributor(DS) (1)
                </Link>
              </li>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400 uppercase ">
                <Link to="/retailer">

                  <FontAwesomeIcon icon={faAnglesRight} /> RETAILER(RT) (2)
                </Link>
              </li>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400  ">
                <Link to={"/not-working"}>
              ...
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400  ">
                <Link to="/suspended-user">

                  <FontAwesomeIcon icon={faAnglesRight} /> Suspended User
                </Link>
              </li>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400  ">
                <Link to="/not-working-user-list">

                  <FontAwesomeIcon icon={faAnglesRight} /> Not Working User (0)
                </Link>
              </li>
            </ul>
            {/* </div>} */}
          ...
          >
            ...
            >
              <FontAwesomeIcon
                icon={faAngleDown}
                className="block"
                style={{ display: `${dropdown.three ? "none " : "block"}` }}
              />
              <FontAwesomeIcon
                icon={faAngleUp}
                className="hidden"
                style={{
                  display: `${dropdown.three ? "block " : "none"}`,
                  color: `${dropdown.three ? "#0056DC " : ""}`,
                }}
              />
            </div>
            ...
            <ul>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400  ">
                <Link to={"/mobile-history"}>
                  <FontAwesomeIcon icon={faAnglesRight} /> Recharge
                </Link>
              </li>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400  ">
                <Link to={"/bill-payments"}>
                  <FontAwesomeIcon icon={faAnglesRight} /> Bill Payments
                </Link>
              </li>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400  ">
                <Link to={"/verify"}>
                  <FontAwesomeIcon icon={faAnglesRight} /> Verify
                </Link>
              </li>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400  ">
                <Link to={"/banking"}>
                  <FontAwesomeIcon icon={faAnglesRight} /> Banking
                </Link>
              </li>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400  ">
                <Link to={"/aeps"}>
                  <FontAwesomeIcon icon={faAnglesRight} /> Aeps
                </Link>
              </li>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400  ">
                <Link to={"/payout"}>
                  <FontAwesomeIcon icon={faAnglesRight} /> Payout
                </Link>
              </li>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400  ">
                <Link to={"/pancard"}>

                  <FontAwesomeIcon icon={faAnglesRight} /> Pancard
                </Link>
              </li>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400  ">
                <Link to={"/upi"}>

                  <FontAwesomeIcon icon={faAnglesRight} /> Upi
                </Link>
              </li>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400  ">
                <Link to={"/wallet-transfer"}>

                  <FontAwesomeIcon icon={faAnglesRight} /> Wallet Transfer
                </Link>
              </li>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400  ">
                <Link to={"/investment"}>
                  <FontAwesomeIcon icon={faAnglesRight} /> Investment
                </Link>
              </li>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400  ">
                <Link to={"/qr-collection"}>
                  <FontAwesomeIcon icon={faAnglesRight} /> QR Collection
                </Link>
              </li>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400  ">
                <Link to={"/pending-report"}>
                  <FontAwesomeIcon icon={faAnglesRight} /> Pending Transaction
                </Link>
              </li>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400  ">
                <Link to={"/admin-report"}>
                  <FontAwesomeIcon icon={faAnglesRight} /> Admin Profit Report
                </Link>
              </li>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400  ">
                <Link to={"/refund-manager"}>
                  <FontAwesomeIcon icon={faAnglesRight} /> Refund Manager
                </Link>
              </li>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400  ">
                <Link to={"/api-summary"}>

                  <FontAwesomeIcon icon={faAnglesRight} /> Api Summary
                </Link>
              </li>
              ...
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400  ">
                <Link to={"/ledger-report"}>
                  <FontAwesomeIcon icon={faAnglesRight} /> Ledger Report
                </Link>
              </li>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400  ">
                <Link to={"/pending-report"}>
                  <FontAwesomeIcon icon={faAnglesRight} /> Payment Report
                </Link>
              </li>
            </ul>
            {/* </div>} */}
          ...
          >
            ...
            >
              <FontAwesomeIcon
                icon={faAngleDown}
                className="block"
                style={{ display: `${dropdown.four ? "none " : "block"}` }}
              />
              <FontAwesomeIcon
                icon={faAngleUp}
                className="hidden"
                style={{
                  display: `${dropdown.four ? "block " : "none"}`,
                  color: `${dropdown.four ? "#0056DC " : ""}`,
                }}
              />
            </div>
            ...
            <ul>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400 ">
                <Link to={"/balance-transfer"}>
                  <FontAwesomeIcon icon={faAnglesRight} /> Balance Transfer
                </Link>
              </li>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400 ">
                <Link to={"/balance-return"}>
                  <FontAwesomeIcon icon={faAnglesRight} /> Balance Return
                </Link>
              </li>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400 ">
                <Link to={"/balance-return-request"}>
              ...
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400 ">
                <Link to={"/payment-view"}>
                  ...
                  <FontAwesomeIcon icon={faAnglesRight} /> Payment Request
                  Review
                </Link>
              </li>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400 ">
                <Link to={"/purchase-bal"}>

                  <FontAwesomeIcon icon={faAnglesRight} /> Purchase Balance
                </Link>
              </li>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400 ">
                <Link to={"/commission-detail"}>
                  <FontAwesomeIcon icon={faAnglesRight} /> Commission Wallet
                  Transfer
                </Link>
              </li>
            </ul>
          ...
          >
            ...
            >
              <FontAwesomeIcon
                icon={faAngleDown}
                className="block"
                style={{ display: `${dropdown.five ? "none " : "block"}` }}
              />
              <FontAwesomeIcon
                icon={faAngleUp}
                className="hidden"
            ...
            <ul>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400 ">
                <Link to={"/pending-disputes"}>
                  ...
                  <FontAwesomeIcon icon={faAnglesRight} /> Pending Dispute
                </Link>
              </li>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400 ">
                <Link to={"/solve-dispute"}>

                  <FontAwesomeIcon icon={faAnglesRight} /> Solved Dispute
                </Link>
              </li>
            </ul>
            {/* </div>} */}
          ...
          >
            ...
            >
              <FontAwesomeIcon
                icon={faAngleDown}
                className="block"
                style={{ display: `${dropdown.six ? "none " : "block"}` }}
              />
              <FontAwesomeIcon
                icon={faAngleUp}
                className="hidden"
                style={{
                  display: `${dropdown.six ? "block " : "none"}`,
                  color: `${dropdown.six ? "#0056DC " : ""}`,
                }}
              />
            </div>
          ...
          >
            ...
            <ul>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400 ">
                <Link to="/fe-income">
                  <FontAwesomeIcon icon={faAnglesRight} /> Field Executive(FE)
                  Income
                </Link>
              </li>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400 ">
                <Link to="/franchise-fsds">
                  <FontAwesomeIcon icon={faAnglesRight} /> FRANCHISE(FSDS)
                  Income
                </Link>
              </li>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400 ">
                <Link to="/super-admin">
                  <FontAwesomeIcon icon={faAnglesRight} /> Super
                  Distributor(SDS) Income
                </Link>
              </li>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400 ">
                <Link to="/retailer-income">
                  <FontAwesomeIcon icon={faAnglesRight} /> RETAILER(RT) Income
                </Link>
              </li>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400 ">
                <Link to="/suspended-user-income">
                  <FontAwesomeIcon icon={faAnglesRight} /> Suspended User (SU)
                  Income
                </Link>
              </li>
              <li className="dropdownList m-4 text-gray-600 hover:text-blue-400 ">
