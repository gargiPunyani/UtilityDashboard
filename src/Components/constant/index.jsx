...
export const retailerSidebar = [{
  ...
  link: [
    { 
      label: "Recharge",
      subLinks: [
        { to: "/retailer-dth-history", label: "DTH" },
        { to: "/retailer-mobile-report-history", label: "Mobile" },
      ],
    },{
    label: "Banking",
    subLinks: [
      { label: "DMT2 History", to: "/retailer-dmt2-history" },
      { label: "DMT3 History", to: "/retailer-dmt3-history" }
    ]
  },{
    label:"Bill Payments",
    subLinks: [
      { label: "Electricity History", to: "/retailer-electricity-history" },
      { label: "Water History", to: "/retailer-water-history" },
      { label: "Loan Repayment History", to: "/retailer-loan-repayment-history" },
      { label: "Landline History", to: "/retailer-landline-history" },
      { label: "Mobile Postpaid History", to: "/retailer-mobile-postpaid-history" },
      { label: "CC Bill Payment History", to: "/retailer-loan-repayment-history" },
    ]}, {
      label: "QR Collection",
      subLinks: [{label:"QR Collection History" , to:"/retailer-qr-collection-history"}]

    }]
},{
  id: "ccBill",
  label: "CC Bill Payment",
  svg: <svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px" fill="#0056DC"><path d="M560-440q-50 0-85-35t-35-85q0-50 35-85t85-35q50 0 85 35t35 85q0 50-35 85t-85 35ZM280-320q-33 0-56.5-23.5T200-400v-320q0-33 23.5-56.5T280-800h560q33 0 56.5 23.5T920-720v320q0 33-23.5 56.5T840-320H280Zm80-80h400q0-33 23.5-56.5T840-480v-160q-33 0-56.5-23.5T760-720H360q0 33-23.5 56.5T280-640v160q33 0 56.5 23.5T360-400Zm440 240H120q-33 0-56.5-23.5T40-240v-440h80v440h680v80ZM280-400v-320 320Z" /></svg>,
  icon: faAnglesRight,
  link:[ {label:"CC Bill Payment",  to: "/retailer-bill-payments" }]
}, {
  id: "ledgerRport",
  label: "Ledger Report",
  svg: <svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px" fill="#0056DC"><path d="M480-280q17 0 28.5-11.5T520-320q0-17-11.5-28.5T480-360q-17 0-28.5 11.5T440-320q0 17 11.5 28.5T480-280Zm-40-160h80v-240h-80v240ZM330-120 120-330v-300l210-210h300l210 210v300L630-120H330Zm34-80h232l164-164v-232L596-760H364L200-596v232l164 164Zm116-280Z" /></svg>,
  icon: faAnglesRight,
  link:[ {label:"LedgerReport", to: "/retailer-ledger-report" }]
}, {
  id: "payment",
  label: "Payment",
  svg: <svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px" fill="#0056DC"><path d="M240-80q-50 0-85-35t-35-85v-120h120v-560l60 60 60-60 60 60 60-60 60 60 60-60 60 60 60-60 60 60 60-60v680q0 50-35 85t-85 35H240Zm480-80q17 0 28.5-11.5T760-200v-560H320v440h360v120q0 17 11.5 28.5T720-160ZM360-600v-80h240v80H360Zm0 120v-80h240v80H360Zm320-120q-17 0-28.5-11.5T640-640q0-17 11.5-28.5T680-680q17 0 28.5 11.5T720-640q0 17-11.5 28.5T680-600Zm0 120q-17 0-28.5-11.5T640-520q0-17 11.5-28.5T680-560q17 0 28.5 11.5T720-520q0 17-11.5 28.5T680-480ZM240-160h360v-80H200v40q0 17 11.5 28.5T240-160Zm-40 0v-80 80Z"/></svg>,
  icon: faAnglesRight,
  link: [{ label: "Balance Return Request", to: "/retailer-balance-return-request" },
  { label: "Payment Request", to: "/retailer-payment-request" }
  ]
}]
export const mainMenuItem = [
    {
      id: 1,
      title: "Master",
      icon: <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#0056DC"><path d="M260-320q47 0 91.5 10.5T440-278v-394q-41-24-87-36t-93-12q-36 0-71.5 7T120-692v396q35-12 69.5-18t70.5-6Zm260 42q44-21 88.5-31.5T700-320q36 0 70.5 6t69.5 18v-396q-33-14-68.5-21t-71.5-7q-47 0-93 12t-87 36v394Zm-40 118q-48-38-104-59t-116-21q-42 0-82.5 11T100-198q-21 11-40.5-1T40-234v-482q0-11 5.5-21T62-752q46-24 96-36t102-12q58 0 113.5 15T480-740q51-30 106.5-45T700-800q52 0 102 12t96 36q11 5 16.5 15t5.5 21v482q0 23-19.5 35t-40.5 1q-37-20-77.5-31T700-240q-60 0-116 21t-104 59ZM280-494Z" /></svg>,      links: [
        { path: "/bank-master", label: "Bank Master" },
        { path: "/role-master", label: "Role Master" },
        { path: "/status-master", label: "Status Master" },
        { path: "/service-master", label: "Service Master" },
        { path: "/payment-beneficiary-method", label: "Payout Beneficiary Master" },
        { path: "/agent-onboarding-list", label: "Agent Onboarding List" },
        { path: "/contact-enquiry", label: "Contact Enquiry" },
        { path: "/company-staff-permission", label: "Company Staff Permission" },
    ...
    },
    {
      id: 2,
      title: "Settings",
      icon: <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#0056DC"> <path d="m370-80-16-128q-13-5-24.5-12T307-235l-119 50L78-375l103-78q-1-7-1-13.5v-27q0-6.5 1-13.5L78-585l110-190 119 50q11-8 23-15t24-12l16-128h220l16 128q13 5 24.5 12t22.5 15l119-50 110 190-103 78q1 7 1 13.5v27q0 6.5-2 13.5l103 78-110 190-118-50q-11 8-23 15t-24 12L590-80H370Zm70-80h79l14-106q31-8 57.5-23.5T639-327l99 41 39-68-86-65q5-14 7-29.5t2-31.5q0-16-2-31.5t-7-29.5l86-65-39-68-99 42q-22-23-48.5-38.5T533-694l-13-106h-79l-14 106q-31 8-57.5 23.5T321-633l-99-41-39 68 86 64q-5 15-7 30t-2 32q0 16 2 31t7 30l-86 65 39 68 99-42q22 23 48.5 38.5T427-266l13 106Zm42-180q58 0 99-41t41-99q0-58-41-99t-99-41q-59 0-99.5 41T342-480q0 58 40.5 99t99.5 41Zm-2-140Z" /></svg>,
      links: [
        { path: "/site-settings", label: "Site Setting" },
        { path: "/company-settings", label: "Company Setting" },
        { path: "/package-setting", label: "Package Setting" },
        { path: "/bank-setting", label: "Bank Setting" },
        { path: "/sms-settings", label: "SMS Setting" },
      ],
    },
  ];
  export const retailerMenuItem=[{
    ...
    icon:<svg xmlns="http://www.w3.org/2000/svg" height="27px" viewBox="0 -960 960 960" width="27px" fill="#0056DC"><path d="M160-120q-33 0-56.5-23.5T80-200v-440q0-33 23.5-56.5T160-720h160v-80q0-33 23.5-56.5T400-880h160q33 0 56.5 23.5T640-800v80h160q33 0 56.5 23.5T880-640v440q0 33-23.5 56.5T800-120H160Zm0-80h640v-440H160v440Zm240-520h160v-80H400v80ZM160-200v-440 440Z"/></svg>,
    links: [
      { path: "/retailer-payment-request", label: "Payment Request" }, 
    ],
  }
]
...
export const retailerHomeCard = [{
  ...
  id: "n",
  type:"category",
  icon: <svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#0056DC"><path d="M420-340h120v-100h100v-120H540v-100H420v100H320v120h100v100Zm60 260q-139-35-229.5-159.5T160-516v-244l320-120 320 120v244q0 152-90.5 276.5T480-80Zm0-84q104-33 172-132t68-220v-189l-240-90-240 90v189q0 121 68 220t172 132Zm0-316Z"/></svg>,
  href: "/retailer-insurance",
  label: "Health Insurance"
}, {
  category_id: 5,
  id: "o",
  type:"category",
  icon:<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#0056DC"><path d="M240-200v40q0 17-11.5 28.5T200-120h-40q-17 0-28.5-11.5T120-160v-320l84-240q6-18 21.5-29t34.5-11h440q19 0 34.5 11t21.5 29l84 240v320q0 17-11.5 28.5T800-120h-40q-17 0-28.5-11.5T720-160v-40H240Zm-8-360h496l-42-120H274l-42 120Zm-32 80v200-200Zm100 160q25 0 42.5-17.5T360-380q0-25-17.5-42.5T300-440q-25 0-42.5 17.5T240-380q0 25 17.5 42.5T300-320Zm360 0q25 0 42.5-17.5T720-380q0-25-17.5-42.5T660-440q-25 0-42.5 17.5T600-380q0 25 17.5 42.5T660-320Zm-460 40h560v-200H200v200Z"/></svg> ,
  href: "/retailer-fastag-service",
  label: "Fastag"
},
{
  category_id: 1,
  id: "p",
  type:"category",
  icon:<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#0056DC"><path d="M440-640v-120H280v-80h400v80H520v120h-80ZM160-120v-320h80v40h120v-120h-40v-80h320v80h-40v120h120v-40h80v320h-80v-40H240v40h-80Zm80-120h480v-80H520v-200h-80v200H240v80Zm240 0Z"/></svg>,
  href: "/retailer-pipe-gas-service",
  label: "Pipe-Gas"
}
// ,{
//   service_id: 21,
...
,{
  ...
  id: "r",
  type:"category",
  icon:<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#0056DC"><path d="M320-80q-66 0-113-47t-47-113v-320q0-57 34-99t86-56v-85q0-33 23.5-56.5T360-880h240q33 0 56.5 23.5T680-800v85q52 14 86 56t34 99v320q0 66-47 113T640-80H320Zm-80-360h480v-120q0-33-23.5-56.5T640-640H320q-33 0-56.5 23.5T240-560v120Zm80 280h320q33 0 56.5-23.5T720-240v-120H240v120q0 33 23.5 56.5T320-160Zm160-280Zm0 80Zm0-40Zm40-320h80v-80H360v80h80q0-17 11.5-28.5T480-760q17 0 28.5 11.5T520-720Z"/></svg>,
  href: "/retailer-gas-cylinder-service",
  label: "Gas Cylinder"
}
]
